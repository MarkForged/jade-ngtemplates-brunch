...
(function() {
  ...
  module.exports = JadeNgtemplates = (function() {
    ...
    function JadeNgtemplates(config) {
      ...
      this.jadeOptions = _.defaults(jadeConfig, this.DEFAULT_JADE_OPTIONS);
      if (this.optimize) {
      ...
      if (this.optimize) {
        ...
        if (_.isBoolean(htmlminConfig)) {
          ...
          this.htmlmin = true;
          this.htmlminOptions = _.defaults(htmlminConfig, this.DEFAULT_HTMLMIN_OPTIONS);
        }
      }
    }
    ...
    JadeNgtemplates.prototype.wrapWithTemplateCache = function(data, path) {
      ...
      */
      ...
      var module, result, url, urlGenerator;
      module = this.findModuleConfig(path);
      ...
      if (!module.moduleWrapInner) {
        return result;
      }
      return this.wrapWithModule(result, module);
    };
